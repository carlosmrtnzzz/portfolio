  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ opacity: 0 }}
      >
        <div className="marquee-bg py-3 sm:py-4">
          <div className="marquee-track flex w-max items-center gap-8 sm:gap-14">
            {marqueeItems.map((tech, i) => (
              <a
                ...
                className="flex flex-shrink-0 items-center gap-2 transition-opacity duration-200 hover:opacity-70"
              >
                <div
                  className="tech-icon h-5 w-5 sm:h-7 sm:w-7"
                  dangerouslySetInnerHTML={{ __html: tech.svg }}
                />
                <span
                  className="whitespace-nowrap text-[11px] font-semibold uppercase tracking-wider sm:text-sm"
